...
#if defined(CONFIG_USB_OTG) || (defined(CONFIG_USB_EHCI_HCD) && defined(CONFIG_USB_FSL_USB2))
	.operating_mode = FSL_USB2_DR_OTG,
#elif defined(CONFIG_USB_FSL_USB2) && !defined(CONFIG_USB_EHCI_HCD)
...
#if !defined(CONFIG_USB_FSL_USB2) && !defined(CONFIG_USB_OTG) && !defined(CONFIG_USB_EHCI_HCD)
